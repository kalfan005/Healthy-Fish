package com.example.healthyfish.Screen7.Fragment1;
...
public class Seafish extends Fragment {
     ...
     * @return A new instance of fragment Seafish.
     */
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       View view = inflater.inflate(R.layout.fragment_seafish, container, false);
        ...
        RecyclerView recyclerView = view.findViewById(R.id.recyclerViewfag1);
    ...
    private void onButtonClick() {
        ...
        Intent intent = new Intent(requireContext(), Fishquantity.class);
